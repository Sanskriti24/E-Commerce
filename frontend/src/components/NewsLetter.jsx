const NewsLetter = () => {
  return (
    <section className="max_padd_container py-12 xl:py-28 bg-white">
        <div className="mx-auto xl:w-[88%] flex items-center justify-center flex-col gap-y-8 w-full max-w-[666px]">
            ...
            <button className="btn_dark_rounded">Subscribe</button></div>
        </div>
    </section>
  )
}
